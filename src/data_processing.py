...
class DataProcessor:
    ...
    def filter_users(self, min_rating=400):
        try:
            ...
            logger.info("Filter useres successfully")
        except Exception as e:
    ...
    def split_data(self, test_size=1000, random_state=43):
        try:
            ...
            X = self.rating_df[["user", "aniem"]].values
    ...
    def save_artifacts(self):
        try:
            ...
            for name, data in artifacts.items():
                ...
                logger.info(f"{name} save successfully in processed directory")
            ...
            raise CustomException("Failed to save artifacts data", e)

    def process_anime_data(self):
        try:
            df = pd.read_csv(ANIME_CSV, low_memory=True)
            cols = ["MAL_ID", "Name", "Genres", "sypsnopsis"]
